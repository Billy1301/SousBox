package com.billy.sousbox.sousbox.flingsswipe;
        ...
        if(getChildCount()>0){
            ...
            if(mActiveCard!=null) {
                ...
                flingCardListener = new FlingCardListener(mActiveCard, mAdapter.getItem(0),
                    ...
                    @Override
                    public void leftExit(Object o) {
                        mFlingListener.onLeftCardExit(o);

                    }

                    @Override
                    public void rightExit(Object o) {
                        mFlingListener.onRightCardExit(o);
                    ...
                    public void onClick(Object o) {
                        if(mOnItemClickListener!=null)
                            mOnItemClickListener.onItemClicked(0, o);
                    }

                    @Override
                    public void onScroll(float v) {
                        mFlingListener.onScroll(v);
